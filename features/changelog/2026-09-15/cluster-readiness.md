...
范围：cluster-e2e 七组断言在单节点 k3s（v1.36.4+k3s1）上首次全绿（61 PASS / 0 FAIL / 1 deliberate SKIP）。
...
## 验证基线（2026-09-15/16）
workspace 525/0 · integration 135/135 · netns 26/26 · egress 21/21 · chart-lint 30/30 · sidecar-e2e 32/32（含新增 S6 chart demo gate）· cluster-e2e 61/0/1。
